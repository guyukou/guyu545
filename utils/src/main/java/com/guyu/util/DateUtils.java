...
public class DateUtils {
    ...
    public long getYearStartMillis() {
        return LocalDateTime.of(LocalDate.now().getYear(), 1, 1, 0, 0)
                .atZone(ZoneId.systemDefault())
                .toInstant().toEpochMilli();
    }
    public static final DateTimeFormatter FMT_SECOND = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm");

    public static void main(String[] args) {
        String s = "123,321,1234,asdfqwer";
